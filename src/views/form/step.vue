      ...
      <el-card shadow="never" body-style="padding: 15px 0 25px 0;">
        <div style="max-width: 700px; margin: 0 auto">
          ...
          >
            ...
            <el-form-item>
              <el-button type="primary" :loading="loading1" @click="submit1">
                下一步
              </el-button>
            </el-form-item>
          </el-form>
          ...
          >
            ...
            <el-form-item>
              ...
              <el-button class="hidden-xs-only" @click="active = 0">
                上一步
              </el-button>
            </el-form-item>
          </el-form>
          <!-- 第三步 -->
          <div v-if="active === 2" style="padding: 0 15px">
            <ele-result title="操作成功" desc="预计两小时内到账">
              <el-form label-width="100px" size="mini" class="ele-form-detail">
                <el-form-item label="付款账户:">
                  <span style="word-break: break-all">{{ form1.account }}</span>
                </el-form-item>
              ...
              <template slot="actions">
                <el-button type="primary" @click="active = 0"
                  >再转一笔</el-button
                >
