<template>
  ...
  >
    <el-form
      ...
      :model="form"
      :rules="rules"
      class="login-form login-form-bg"
      @keyup.enter.native="submit"
    >
      <h4 style="color: white;font-weight: bold;">{{ $t('login.title') }}</h4>
    ...
    <!-- <div class="login-copyright">
      copyright © 2021 <a href="http://www.sharp-i.net" target="_blank" style="color: white;">www.sharp-i.net</a> all rights reserved.
    </div> -->
    <!-- 多语言切换 -->
